/**
 * @description: 外部工具列表，收集一些有用的在线工具用于显示。
 */
export const OtherTools = [
    {
        ...
        icon: 'XUkV6cg.fY6jpZ4rlk*VSmX0y=O?2vWOqaclOrUwdpWizbFJyoCcAkVfEpRAftYst.PNLAKS.b;BFuSV4dRNrnWgT8BfwpAd29CJhzXvThHGamTAxtJRIhX,LoIc7uXwVxDhXyKf2pTq2sLC/pCxFwTxH.XdfdYuIuY?rcDNCvH&tpG::rLyN.Ed*cCFIaRtnfXg80VfH3AcGwLcRwT,CcOftD;?*aCCwrSNHsCBf8BbrsE?CfdMt.FLCqHh:wSQJuVCzbFKGtCcAnSPchTBK8HcRnCa&g.VqlGMAdGSHvHNLaCd37EwAfQxK9CJhYC::aOFW.PwpbX2L2BdT.FRMzRPElAdyMBb/YC::aHCqrQQFuCGf2Ba:aCBj8Bc-cABYoYAKfJKCsLBB.SANjT1gtIJCqG?HfWgY3AdChHACwJKCsHh:fSQpmJRHcSdTeCd37EwAfQxK9CJhYC::aHB/1VANyYBAxIJCpG?HfYMrcENOhH;GjSPHtORCtWBIcCFYiV=q1CcLwFcPzRAChHAKcZ;KnXVycSA1sJRImUNLcWAThIdD2DxLkdAJ1=IiaHB/.G?1hJfzDB/:ZC=wmB;EmQRHyOLCdSKvtcF,cSsA4=Pn.B/:ZC?;7WfMdW?&3OLBpHKCadStbD?AaY1kdX=a1CdHvBb*iRQfm.AJ0CbCqHh:rW=scGhH.Wee1CdHhB;QjUAq8HbGdTeScOipoUgNdYC3G&.:ZC?;fB?ouRRbzHA.0CbGvHh:yGMArHRH.Rtr.XxL8BgIyW?CfYfejW&ucHy=rEddeShH.X=PwY?0gVfEiUxC8HfugT,LmYRB3I=opYFUxX:yF?c;fB&-2DwX9CJhYC::aOFW.PwpbX2L2BdT.FRMzRPElAdyMBb/YC::aHCqrQQFuCGf2BaOoCcA4IL;qAc&2.PKrV&ucLi/b;A.fVVchX:uaGd;hBAAyHMCxHb:pZLucLhB.QgdmWCzbBtTeTcH9I&0sRQHzO.tBC::aHB/.GBJfZGP.Y:uaHd;hBAb3Ad,0Hb:aW,;tbytbVB.uChAfUNrkJMHiFM;wGQLhHb:rTPbuKV,nPw.pXizbVNfcTAwkBcwFH?3zYQarJZuEHB/.;=opTy3G&.:ZC?;7Sr*dUA;ybst.Te,nb2KaPwkcJfzDB/:ZC?;fIAAfQxKfd?t.HrOcHGd2;d*cCGciS,LgJMHxF&;aTAPoYvarJKCsLBB.UhZ3CiHbB,DxJMHxBb*gTQrrOLBaTeTgHix1CxBfS2P3?HiZC?;fB&-2WAP3c&:vJKCyMRB.WNscGSTbB=HkSRMyILAuXBKhH;SgW,q3HhFqDdQzTFHbB,LdZBPsRPwdTA3xOLCkVOLeaFNbGes2F2QeY,K2=KnfB&-aH?3mO.tBJ:3tclW3',
        url: "amkjk87*bXddUVig*bg6"
    }, {
        name: 'Zamzar',
        description: '免费的在线视频转换器、音频转换器、图像转换器、电子书转换器。无需下载或注册账户。支持超过1200种格式的转换。',
